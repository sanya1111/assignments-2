...
public class TrackerResponseWriter {
    private DataOutputStream dataStream;

    public TrackerResponseWriter(Socket socket) throws IOException {
    ...
    public void writeResponse(TrackerResponse response) throws IOException {
